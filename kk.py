...
RfuBot=[lineMID]
Family=["u12dce86086cbc3aa192654a5e04a2a77",lineMID]
admin=['u12dce86086cbc3aa192654a5e04a2a77',lineMID]
adminMID="u12dce86086cbc3aa192654a5e04a2a77"
...
settings = {
    ...
    "Respontag":"❌MNT-Selfbot❌",
    "ResponPM":"❌MNT-Selfbot❌",
    "message":"❌MNT-Selfbot❌",
    "comment":"❌MNT-Selfbot❌",
    "Wc":"❌MNT-Selfbot❌",
    "bye":"❌MNT-Selfbot❌",
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    start = time.time()
                    line.sendMessage(to, "『❌MNT-Selfbot❌』")
